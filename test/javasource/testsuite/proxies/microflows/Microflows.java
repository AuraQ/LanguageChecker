...
public class Microflows
{
	...
	public static boolean iVK_LangTest(IContext context, system.proxies.Language _language)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Language", _language == null ? null : _language.getMendixObject());
			return (Boolean)Core.execute(context, "TestSuite.IVK_LangTest", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
